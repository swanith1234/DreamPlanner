...
export const TOOLS = [
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    deadline: { type: 'string', description: 'CRITICAL: Must be exact YYYY-MM-DD format. Do NOT use words like "tomorrow" or "next week".' },
                    ...
                    startDate: { type: 'string', description: 'CRITICAL: Must be exact YYYY-MM-DD format. Do NOT use words.' },
                    ...
                    checkpoints: {
                        ...
                        items: {
                            ...
                            properties: {
                                title: { type: 'string' },
                                targetDate: { type: 'string', description: 'CRITICAL: Must be exact YYYY-MM-DD format.' },
                ...
                required: ['title', 'deadline', 'dreamId', 'priority', 'checkpoints'],
            },
        },
    },
        ...
        function: {
            ...
            parameters: {
                ...
                properties: {
                    ...
                    title: { type: 'string' },
                    description: { type: 'string' },
                    deadline: { type: ['string', 'null'], description: 'CRITICAL: Must be exact YYYY-MM-DD format.' },
                    priority: { type: ['integer', 'null'], minimum: 1, maximum: 5 },
                    startDate: { type: ['string', 'null'], description: 'CRITICAL: Must be exact YYYY-MM-DD format.' },
    ...
    },
    {
        type: 'function',
        function: {
            name: 'updateProgressQuick',
            description: 'Instantly update the user\'s active task or checkpoint progress. No confirmation needed.',
            parameters: {
                type: 'object',
                properties: {
                    amount: { type: 'integer', minimum: 1, maximum: 100 },
                    type: { type: 'string', description: 'BY or TO' },
                },
...

    {
        ...
        function: {
            name: 'syncDreamState',
            description: 'Create a new dream by collecting 6 required fields: title, domain, targetGoal, currentSkillLevel, deadline (YYYY-MM-DD), motivationStatement. Set confirmed=true only after explicit user confirmation.',
            parameters: {
                type: 'object',
                properties: {
                    title: { type: 'string', description: 'Name of the dream' },
                    domain: { type: 'string', description: 'Area of interest e.g. Product Development, Fitness, Finance' },
                    targetGoal: { type: 'string', description: 'What does success look like?' },
                    currentSkillLevel: { type: 'string', description: 'Beginner, Intermediate, or Advanced' },
                    motivationStatement: { type: 'string', description: 'Why is this dream important to the user?' },
                    deadline: { type: 'string', description: 'CRITICAL: Must be exact YYYY-MM-DD format. Do NOT use words.' },
                    impactScore: { type: 'integer', minimum: 1, maximum: 10, description: 'Optional: how impactful is this dream (1-10)' },
                    confirmed: { type: 'boolean', description: 'Set to true only after the user explicitly says yes/confirm' },
                },
                required: ['title', 'domain', 'targetGoal', 'currentSkillLevel', 'deadline', 'motivationStatement'],
            },
        },
    },
